...
import LoserImage from "../../assets/lose.png";
...
export default function GameScreen() {
  ...
  return (
    <div>
      <div id="cave" className={styles["game_container"]}>
      ...
      >
        <img className="w-2/3 mb-6" src={LoserImage} alt="you are lose image" />
